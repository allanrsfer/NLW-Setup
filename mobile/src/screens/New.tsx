...
export function New() {
  ...
  async function handleCreateNewHabit() {
    try{
      ...
      console.log(error);
      Alert.alert("Ops", "Nao foi possível criar o novo habito");
    };
  };
  ...
  return (
    <View className="flex-1 bg-background px-8 pt-16">
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 100}}>
        ...
        <TouchableOpacity 
          className="w-full h-14 flex-row items-center justify-center bg-green-600 rounded-md mt-6" activeOpacity={0.7}
